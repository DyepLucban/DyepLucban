...
- 🔧 Backend Developer based in General Trias, Cavite, Philippines
- 🎮 Passionate on creating game using Unity
- 🤖 Leverage AI-assisted tools (Claude Code, GitHub Copilot) to speed up reviews, testing, and integrations
